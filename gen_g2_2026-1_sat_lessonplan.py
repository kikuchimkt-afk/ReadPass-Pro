...
DEFAULT_DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data", "grade2", "2026-1-sat", "data.json")
...
fp1 = {
    ...
    "practiceQuestions": [
        ...
        {
            "q": "「It was not until the 1940s ...」と「since the early 2000s」から、発見と保護の順序を説明してください。",
            "a": "水中部分が注目され始めたのは1940年代で、その後2000年代初頭から保護海域として管理されている。not until は開始が遅かったこと、since はその時点から現在までの継続を表す。"
        }
    ],
    "highlightPatterns": [
...
fp2 = {
    ...
    "practicePassage": {
        ...
        "ja": "枯れ木はしばしば生命に満ちあふれている。例えば森の中では、枯れ木はさまざまな方法で多くの異なる動物や昆虫を支えている。木が生きていなかったり立っていなかったりすると、それは多くの生き物にとっての生息地、つまり住む場所になる。まず、キノコが木の分解を助ける。これにより昆虫は木の中に入って卵を産むことができる。すると今度は、新しい昆虫やその他の生き物が育ち始める。木から剥がれ落ちた樹皮の下に隠れる小動物もいる。木の穴に巣を作る鳥もいる。",
...
fp4 = {
    ...
    "practicePassage": {
        ...
        "ja": "スロバキアの中心都市ブラチスラバでは、「City for Children（子どものための都市）」プログラムを通じて、子どもに優しい都市をつくる取り組みが行われてきた。多くの学校が危険に囲まれており、試験的に安全対策が取られた。成功例の一つがネヴァヅォヴァー通りで、かつては学校に子どもを送り届けようとする親が運転する何十台もの車で混雑していた。現在では、子どもが登校する時間帯にはこの通りへの車の乗り入れが禁止されている。その代わり、午前7時30分から8時までの登校時間帯には、子どもたちは自分たちだけで歩いて学校へ行くことができる。ブラチスラバでは、どんなアイデアも恒久的に導入される前に試験的に検証されるのだ。",

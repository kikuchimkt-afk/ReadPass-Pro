            ...
            "questions": [
                {
                    ...
                    "answer": 1,
                    "choiceAnalysis": [
                        "✅ 教育資源の不足→正解。💡 Literacy rates were low（識字率が低い）＋few students had access to books（本にアクセスできない）が直接の根拠",
                        "❌ 子ども数の減少→本文に子どもの数が減ったという記述はない",
                        "❌ 安全な通学路の喪失→通学路・安全ルートの話は一切出てこない",
                        "❌ 村人同士の協力不足→an artist and young people worked together（協力して取り組んだ）と矛盾",
                    ],
                ...
                },
                {
                    ...
                    "answer": 1,
                    "choiceAnalysis": [
                        "✅ 多くの人が舞台裏で働いた→正解。💡 Costumes were created, rumors were spread, and dramatic scenes were performed（衣装・うわさ・演出）という裏方の準備がイベント成功の理由",
                        "❌ 家で静かに見ていた→community event（地域イベント）・brought people together（人を集めた）と逆",
                        "❌ 会うのを待たなかった→Motivated by this, children began writing（子どもが物語を書き始めた）と矛盾",
                        "❌ 衣装について話した→衣装の「話」ではなく、衣装を「作る」などの裏方作業がポイント",
                    ],
                ...
                },
                {
                    ...
                    "answer": 3,
                    "choiceAnalysis": [
                        "❌ To begin with＝まず第一に。話の導入・列挙の始まり。ここはニューヨーク版の具体例の結果を述べる位置",
                        "❌ Unfortunately＝残念ながら。否定的な転換だが、直後は creative twist（創造的な工夫）という前向きな内容",
                        "✅ In this way＝このようにして→正解。💡 地下鉄のスーパーヒーローという工夫によって、公共の読書にひねりを加えたという結果・方法のまとめ",
                        "❌ On the other hand＝一方で。ホンジュラス版との対比ではなく、ニューヨーク版の効果を述べている",
                    ],
            ...
            "questions": [
                {
                    ...
                    "answer": 2,
                    "choiceAnalysis": [
                        "❌ 眠く穏やかに→心拍数上昇・筋肉緊張（覚醒反応）と正反対",
                        "✅ 逃げるか防御の準備→正解。💡 fight-or-flight response（闘争・逃走反応）＋gets the body ready to act immediately（すぐ行動できるようにする）と一致",
                        "❌ 体の動きを止める→act immediately（すぐ行動）と矛盾",
                        "❌ 怖がらないふり→恐怖反応の本質（危険への備え）と逆",
                    ],
                ...
                },
                {
                    ...
                    "answer": 1,
                    "choiceAnalysis": [
                        "✅ この感情に夢中→正解。💡 直後の They like scary things and seek excitement（怖いものが好きで興奮を求める）が言い換え",
                        "❌ 目を開けるのを怖がる→本文にない。映画を見る場面では「目を開けない」話ではない",
                        "❌ すぐに恐怖を忘れる→恐怖を楽しむ・求める流れと逆",
                        "❌ 友人を驚かせる→roller coasters（ジェットコースター）など自己の興奮の話で、他人を驚かせる話ではない",
                    ],
                ...
                },
                {
                    ...
                    "answer": 4,
                    "choiceAnalysis": [
                        "❌ On the other hand＝一方で。前段の「恐怖を楽しむ人」との対比ではなく、同じ「問題のある恐怖」の具体化",
                        "❌ Fortunately＝幸いにも。直後は overwhelming and difficult（圧倒的で困難）という否定的内容",
                        "❌ Without this＝これがなければ。文脈に合う先行詞がなく、文法的に不自然",
                        "✅ In particular＝特に→正解。💡 too often or too intensely（頻繁・過度に恐怖）のケースを特に強調し、日常生活への影響を述べる",
                    ],

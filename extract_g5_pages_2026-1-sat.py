...
pdf_path = os.path.join(base_dir, "2026-1-sat_5級.pdf")
output_dir = os.path.join(base_dir, "pages_g5_2026-1-sat")
...
answer_pdf = os.path.join(base_dir, "2026-1-sat_5級_解答.pdf")
answer_dir = os.path.join(base_dir, "answer_pages_g5_2026-1-sat")

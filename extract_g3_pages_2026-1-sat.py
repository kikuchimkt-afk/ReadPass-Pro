...
pdf_path = os.path.join(base_dir, "2026-1‐sat_3級.pdf")
output_dir = os.path.join(base_dir, "pages_g3_2026-1-sat")
...
answer_pdf = os.path.join(base_dir, "2026-1‐sat_3級_解答.pdf")
answer_dir = os.path.join(base_dir, "answer_pages_g3_2026-1-sat")

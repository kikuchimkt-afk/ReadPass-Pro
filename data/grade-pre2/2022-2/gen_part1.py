...
section2 = {
    ...
    "questions": [
        ...
        {
            "number": 25,
            "text": "A : That's a great idea! I think there's something about them in our textbook.\nB : OK, but you should also ( 25 ).\nA : I'll see what I can find at the library. Also, I can take a look on the Internet.\nB : If you need more help, come and talk to me anytime.",
            "translation": "A：それはいい考えですね！教科書に何か載っていると思います。\nB：わかった。でも、ほかにも( 25 )べきだよ。\nA：図書館で何が見つかるか調べてみます。あと、インターネットでも見てみます。\nB：もっと助けが必要なら、いつでも来て話してね。",

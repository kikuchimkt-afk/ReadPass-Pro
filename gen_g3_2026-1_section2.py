    ...
    "questions": [
        {
            ...
            "choiceAnalysis": [
                ...
                "It's my favorite game＝「それが一番好きなゲーム」。パソコンの使い方を教えてほしいという依頼に答えていない。",
            ...
            "translation": "姉／妹：ジム、パソコンの使い方を教えてくれない？\n兄／弟：（　）このテレビ番組はあと10分で終わるよ。",
            "choiceTranslations": [
                "前にやったことがあるよ。",
                "それが一番好きなゲームだよ。",
                "すぐ手伝うよ。",
        ...
        },
        {
            ...
            "grammarSimple": "I have a stomachache は「おなかがいたい」。おうちにかえってやすむように言われるよ。",
            "choiceAnalysis": [
            ...
            "choiceAnalysisSimple": [
                "○「おなかがいたい」。れんしゅうにいけないし、やすむように言われるよ。",
        ...
        },
        {
            ...
            "choiceAnalysis": [
                "Have a nice trip＝「良い旅を」。この発言は旅行する本人ではなく母に向けられており、母の OK, I will. ともつながらない。",
            ...
            "choiceAnalysisSimple": [
                "「良い旅を」はママへのお願いではないので、「わかった、するね」とつながらないよ。",

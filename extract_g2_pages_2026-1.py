...
pdf_path = os.path.join(pdf_dir, "2級.pdf")
output_dir = os.path.join(base_dir, "pages_g2_2026-1")
...
answer_pdf = os.path.join(pdf_dir, "2級解答.pdf")
answer_dir = os.path.join(base_dir, "answer_pages_g2_2026-1")

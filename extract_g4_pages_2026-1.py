...
pdf_path = os.path.join(pdf_dir, "4級.pdf")
output_dir = os.path.join(base_dir, "pages_g4_2026-1")
...
answer_pdf = os.path.join(pdf_dir, "4級解答.pdf")
answer_dir = os.path.join(base_dir, "answer_pages_g4_2026-1")

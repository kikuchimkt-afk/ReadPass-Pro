# -*- coding: utf-8 -*-
"""Verify 2026-1 grade4（本会場）section3 (sentence-order) structure and answers."""
import json
import os
import sys
...
EXPECTED = {21: 2, 22: 1, 23: 2, 24: 3, 25: 3}
...
if errors:
    sys.exit(1)
print("OK: section3 Q21-25 with rich explanations")
